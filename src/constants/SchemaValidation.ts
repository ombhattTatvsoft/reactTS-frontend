export const SCHEMA = {  
    ...
    // // holiday schema
    // HOLIDAY_NAME_SIZE: "Holiday name must be 100 characters or less",
    // ADD_PAST_HOLIDAY: "You cannot add a holiday in the past.",
    // EDIT_PAST_HOLIDAY: "You cannot edit past holidays.",
  };
